...
def generate_launch_description():
    ...
    spawn_entity_list = [
        # Left side
        ('obstacle_bot_0', 6.0, 8.0, 0.0, 0.0, 0.0, -1.5708),
        ('obstacle_bot_1', 4.0, 8.0, 0.0, 0.0, 0.0, -1.5708),
        ('obstacle_bot_2', 2.0, 8.0, 0.0, 0.0, 0.0, -1.5708),
        ('obstacle_bot_3', -0.0, 8.0, 0.0, 0.0, 0.0, -1.5708),
        ('obstacle_bot_4', -2.0, 8.0, 0.0, 0.0, 0.0, -1.5708),
        ('obstacle_bot_5', -4.0, 8.0, 0.0, 0.0, 0.0, -1.5708),
        # Right side
        ('obstacle_bot_6', 5.0, -8.0, 0.0, 0.0, 0.0, 1.5708),
        ('obstacle_bot_7', 3.0, -8.0, 0.0, 0.0, 0.0, 1.5708),
        ('obstacle_bot_8', 1.0, -8.0, 0.0, 0.0, 0.0, 1.5708),
        ('obstacle_bot_9', -1.0, -8.0, 0.0, 0.0, 0.0, 1.5708),
        ('obstacle_bot_10', -3.0, -8.0, 0.0, 0.0, 0.0, 1.5708),
        ('obstacle_bot_11', -5.0, -8.0, 0.0, 0.0, 0.0, 1.5708),
    ]
