...
from carverabwu.src.awbu_drl.scripts.drlagent_base_agent import OffPolicyAgent, Network, OUNoise
...
class TD3(OffPolicyAgent):
    def __init__(self, device, sim_speed):
        ...
        # DRL parameters
        self.noise = OUNoise(action_space=self.action_size, max_sigma=0.9, min_sigma=0.1, decay_period=1_000_000)
