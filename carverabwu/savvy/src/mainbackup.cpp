...
// std_msgs__msg__Int16 inputcontrolL_msg;

// //input controlR
// rcl_publisher_t inputR_publisher;
// std_msgs__msg__Int16 inputcontrolR_msg;
...
//   if (timer != NULL) {
// 	ENCR_msg.data = counttimer; //fix this
...
// 	inputcontrolL_msg.data = pidParameter1.setPoint;
// 	inputcontrolR_msg.data = pidParameter2.setPoint;
// 	// wheelL_vel_msg.data = control.getIntervalEnc(&encoderL);
// 	// wheelR_vel_msg.data = control.getIntervalEnc(&encoderR);
...
// 	// IMU_msg.orientation.x = counttimer;
...
// 	RCCHECK(rclc_publisher_init_default(&inputL_publisher, &node, ROSIDL_GET_MSG_TYPE_SUPPORT(std_msgs, msg, Int16), "inputL"));
// 	RCCHECK(rclc_publisher_init_default(&inputR_publisher, &node, ROSIDL_GET_MSG_TYPE_SUPPORT(std_msgs, msg, Int16), "inputR"));
...
//     while (true)
//     {
// 		// Serial.println(String(countmicro));
// 		// countmicro++;
// 		// Serial.println("uROSloop");
// 		// Serial.println("This Task run on Core: " + String(xPortGetCoreID()));
//         uROSloop(); // in this have bug
// 		// countmicro++;
//     }
// }
...
// 	//parameter setup
// 	pidParameter1.Kp = 1;//3;  //1;   //4
//     pidParameter1.Ki = 0.5;//0.5; //8;
//     pidParameter1.Kd = 0.0;
//     pidParameter1.sampleTime = intervalPID;

//     pidParameter2.Kp = 1;//3;  //1;   //4
//     pidParameter2.Ki = 0.5;//0.5; //8;
...
// 		robotVelocityCmd.v1 = 1;
// 		robotVelocityCmd.v2 = 1;
// 		// // inverse kinematics
...
// 		// Serial.println("This Task run on Core: " + String(xPortGetCoreID()));
// 		// counttimer++;
// 		// Serial.println(String(counttimer));
...
// //     // }
// // 	// Serial.println(i);
// //     // control.drive(&motorL, i*(-25));
// //     // control.drive(&motorR, i*(-25));
// // 	// delay(5000);
// // 	// ++i;
// // 	// if(i>10){
// // 	// 	i = 0;
